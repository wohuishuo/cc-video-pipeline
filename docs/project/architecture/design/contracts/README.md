...
| --- | --- | --- | --- |
| Workspace Access | workspace/root policy, scope and environment-only credential | atomic access registry + redacted decision | `apps/workspace-access/workspace_access/registry.py` |
