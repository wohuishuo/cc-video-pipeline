...
| 11 | Workspace access owner | workspace identity, roots, hashed short-lived scopes, expiry and revocation | Domain complete; Studio composition pending |
| 12 | Hosted/mobile admission | HTTP auth composition, tenant storage, remote identity, resource budgets, security evidence | Pending |
