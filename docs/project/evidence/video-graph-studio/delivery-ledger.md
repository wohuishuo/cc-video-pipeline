...
| Evidence present | graph/run/process contracts; SQLite idempotency; durable FIFO start queue; queued cancellation isolation; real child-process ordering and cleanup; process-wide execution gate; optional Resource Budget composition; complete-catalog admission and truncated-catalog rejection; exact local folder inventory including OneDrive roots; separately selectable NLLB/DeepSeek and Edge/Qwen3/original policies; zero-route local-output admission; seven-stage responsive browser drill; real loopback HTTP and Client Contracts discovery; secure fixed and multi-workspace admission; browser-admitted folder intake; successful anonymous YouTube download; real transcription, RU+KK translation and Source-to-Localization runs; real Douyin creator discovery; domain-tested Creator+Dub continuation and derivative verification; publication planning; confirmed private YouTube execution through Publication and Vault with a fake platform boundary; live process-tree crash, startup fence and same-run recovery |
