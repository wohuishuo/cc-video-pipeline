...
| Evidence present | independent launcher; env-only intake; CurrentUser DPAPI; contextual binding; provider isolation; replay/conflict; explicit rotation/revocation; ciphertext destruction; redacted results; atomic registry; child argv execution; real Windows and guarded-publication drills |
