...
Graph Studio tests prove eight ordered owner steps, exact selected-language voice coverage, public adapter registration, clip hash/size/duration verification and browser controls for folder/URL voice workflows. A live eight-step browser run is not yet claimed.
