...
### 1. 静音切除（口播粗剪第一步）
```powershell
.\.Codex\skills\edit-ffmpeg\scripts\silence_cut.ps1 -Video ".\input.mp4" -Out ".\output.mp4"
# 可选参数
.\.Codex\skills\edit-ffmpeg\scripts\silence_cut.ps1 -Video ".\input.mp4" -Out ".\output.mp4" -Noise "-30dB" -MinDuration 1.5
```
...
```powershell
# 模糊填充背景（推荐，视觉舒适）
.\.Codex\skills\edit-ffmpeg\scripts\to_vertical.ps1 -Video ".\input.mp4" -Out ".\output_9x16.mp4" -Mode blur

# 主体居中裁切（适合主体始终在中间的）
.\.Codex\skills\edit-ffmpeg\scripts\to_vertical.ps1 -Video ".\input.mp4" -Out ".\output_crop.mp4" -Mode crop

# 上下留黑 + 字幕烧录
.\.Codex\skills\edit-ffmpeg\scripts\to_vertical.ps1 -Video ".\input.mp4" -Out ".\output_cap.mp4" -Mode captions -Subtitle ".\audio.srt"
```
...
```powershell
.\.Codex\skills\edit-ffmpeg\scripts\reframe.ps1 -Video ".\podcast.mp4"
.\.Codex\skills\edit-ffmpeg\scripts\reframe.ps1 -Video ".\interview.mp4" -Motion smooth -FacePick speaker
```
...
.\.Codex\skills\edit-ffmpeg\scripts\to_vertical.ps1 -Video input.mp4 -Out out_vert.mp4 -Mode blur
```
