...
def test_shell_is_a_six_stage_creator_campaign_workspace_without_canvas_controls():
    html = (WEB / "index.html").read_text(encoding="utf-8")
    for stage in ("creator", "videos", "languages", "destinations", "review", "activity"):
...
def test_shell_loads_only_local_versioned_assets():
    ...
    assert 'type="module" src="/app.js?v=10"' in html
