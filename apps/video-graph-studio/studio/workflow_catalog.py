...
WORKFLOW_METADATA: dict[str, dict[str, str]] = {
    ...
    "creator-campaign": {"goalId":"creator-campaign","group":"Batch","title":"Run a selected creator campaign","summary":"Localize an exact verified subset from a completed creator catalog.","sourceKind":"run","effect":"downloads-source"},
...
NODE_METADATA: dict[str, dict[str, str]] = {
    ...
    "select-creator-videos": {"title":"Select creator videos","description":"Commit the exact selected subset without downloading media.","owner":"creator-selection","relationship":"Command","loop":"Selection","retry":"Stable operation checkpoint","output":"Creator Selection Manifest"},
    "verify-selection": {"title":"Verify selection","description":"Check source lineage and exact selected video coverage.","owner":"creator-selection","relationship":"Policy","loop":"Selection","retry":"Recheck only","output":"Verified selection fact"},
...
WORKFLOW_REQUIREMENTS: dict[str, list[str]] = {
    ...
    "creator-campaign": ["creator-run", "video-selection", "asr", "languages", "translation", "voices", "source-volume"],
